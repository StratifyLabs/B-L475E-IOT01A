...
#define SOS_BOARD_SYSTEM_CLOCK 80000000
...
#define STM32_ARCH_CLOCK_PLLM 1
#define STM32_ARCH_CLOCK_PLLN 40
#define STM32_ARCH_CLOCK_PLLP 7
#define STM32_ARCH_CLOCK_PLLQ 2
#define STM32_ARCH_CLOCK_PLLR 2
#define STM32_ARCH_CLOCK_AHB_CLOCK_DIVIDER 1
#define STM32_ARCH_CLOCK_APB1_CLOCK_DIVIDER 1
#define STM32_ARCH_CLOCK_APB2_CLOCK_DIVIDER 1
#define STM32_ARCH_CLOCK_VOLTAGE_SCALE 1
#define STM32_ARCH_CLOCK_FLASH_LATENCY 4

//--------------------------------------------Disco Definitions-------------------------------------------------

//USART1 PB6 and PB7
#define DISCO_DEBUG_UART_PORT 0
#define DISCO_DEBUG_UART_RX_PORT 1
#define DISCO_DEBUG_UART_RX_PIN 7
#define DISCO_DEBUG_UART_TX_PORT 1
#define DISCO_DEBUG_UART_TX_PIN 6
#define DISCO_LED_PORT 1 //PB14
#define DISCO_LED_PIN 14
#define DISCO_BOOT_HARDWARE_REQUEST_PORT 2 //PC13
#define DISCO_BOOT_HARDWARE_REQUEST_PIN 13
